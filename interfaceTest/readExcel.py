...
if __name__ == '__main__':#我们执行该文件测试一下是否可以正确获取Excel中的值
    print(readExcel().get_xls('cainiaotaojin.xlsx', 'user'))
    # print(type(readExcel().get_xls('cainiaotaojin.xlsx', 'user')[0][4]))
    # print(code(readExcel().get_xls('cainiaotaojin.xlsx', 'user')[0][4]))
    # # print(readExcel().get_xls('cainiaotaojin.xlsx', 'user')[1][2])